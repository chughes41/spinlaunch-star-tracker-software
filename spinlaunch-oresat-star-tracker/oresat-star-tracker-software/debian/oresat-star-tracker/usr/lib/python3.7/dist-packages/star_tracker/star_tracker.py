...
class StarTracker:
    ...
    def start(self, median_path, config_path, db_path):
        ...
        #logger.info(self.snapper.capture_snap(self.snap_count))
    ...
    # Change the current camera exposure time (in s)
    def SetExposure(self, Exposure):
        self.snapper.set_exposure(Exposure)
    
    # Change the current camera gain
    def SetGain(self, Gain):
        self.snapper.set_gain(Gain)
